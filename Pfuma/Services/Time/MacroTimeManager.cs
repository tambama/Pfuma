...
namespace Pfuma.Services.Time
{
    ...
    public class MacroTimeManager : IMacroTimeManager  
    {
        ...
        public static List<TimeRange> InitializeMacros()
        {
            ...
            {
                new TimeRange(new TimeSpan(1, 00, 0), new TimeSpan(1, 10, 0)),
                new TimeRange(new TimeSpan(2, 00, 0), new TimeSpan(2, 10, 0)),
                new TimeRange(new TimeSpan(3, 00, 0), new TimeSpan(3, 10, 0)),
                new TimeRange(new TimeSpan(4, 00, 0), new TimeSpan(4, 10, 0)),
                new TimeRange(new TimeSpan(5, 00, 0), new TimeSpan(5, 10, 0)),
                new TimeRange(new TimeSpan(6, 00, 0), new TimeSpan(6, 10, 0)),
                new TimeRange(new TimeSpan(7, 00, 0), new TimeSpan(7, 10, 0)),
                new TimeRange(new TimeSpan(8, 00, 0), new TimeSpan(8, 10, 0)),
                new TimeRange(new TimeSpan(9, 00, 0), new TimeSpan(9, 10, 0)),
                new TimeRange(new TimeSpan(9, 30, 0), new TimeSpan(10, 10, 0)),
                new TimeRange(new TimeSpan(11, 00, 0), new TimeSpan(11, 10, 0)),
                //new TimeRange(new TimeSpan(11, 50, 0), new TimeSpan(12, 10, 0)),
                new TimeRange(new TimeSpan(13, 30, 0), new TimeSpan(13, 40, 0)),
                new TimeRange(new TimeSpan(14, 50, 0), new TimeSpan(14, 10, 0)),
                ...
                new TimeRange(new TimeSpan(00, 00, 0), new TimeSpan(0, 10, 0))
            };
        }
    }
}