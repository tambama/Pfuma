...
namespace Pfuma.Detectors
{
    ...
    public class VenomDetector : BasePatternDetector<Level>
    {
        ...
        public void CheckForVenom(Level fvg)
        {
            ...
            bool candle2HasSweep = (candle2.SweptLiquidity > 0 || candle2.SweptCycle); //&& (candle2.HasSMT || candle2.SweptFibonacci > 0); // || candle3.InsidePda;
            bool candle3HasSweep = (candle3.SweptLiquidity > 0 || candle3.SweptCycle); //&& (candle3.HasSMT || candle3.SweptFibonacci > 0); // || candle3.InsidePda;
